...
用法:
    # 归档已完成的诊断
    python -m tools.session_archiver archive --session X2EXAMPLE00001 \\
        --report diagnosis_report.md --root-cause "遥控器误操作触发JOINT_DEFAULT" \\
        --fault-ids X2-FK-302

    # 从确认案例生成技能草稿
    python -m tools.session_archiver extract-skill --session X2EXAMPLE00001
...
def cmd_pending(args):
    ...
    print("  或直接说 session ID: X2EXAMPLE00001 验证结果 correct")
